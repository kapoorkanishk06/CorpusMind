        ...
        <>
          ...
          <div
            ...
            <SpotlightCard className="custom-spotlight-card" spotlightColor="rgba(132, 0, 255, 0.25)">
              ...
              <br></br>
              <p>Build your institution's knowledge base from
                PDFs, DOCX files, emails and policies.</p>
            </SpotlightCard>
          </div>
        </>
      )}
          ...
          >
            ...
            >
              ...
              <p style={{ fontSize: "1.2rem" }}>
                Students must maintain <b>75% attendance</b>
                except for approved medical leave.
              </p>
              ...
              <ul>
                <li>Attendance_Policy.pdf</li>
                <li>Student_Handbook.docx</li>
              </ul>

              <h3>Related Documents</h3>

              <ul>
                <li>Academic_Regulations.pdf</li>
              </ul>
            </div>
            ...
            >
              ...
              <p>
                <b>Attendance_Policy.pdf</b>
                <br />
                Minimum attendance = 75%
              </p>

              <p>
                <b>Academic_Regulations.pdf</b>
                <br />
